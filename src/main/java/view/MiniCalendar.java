...
public class MiniCalendar extends JPanel {
    ...
    public MiniCalendar(JLabel dateLabel) {
    ...
    public void updateCalendar() {
        ...
        for (int week = 0; week < 6; week++) {
            ...
            for (int dayOfWeek = 0; dayOfWeek < 7; dayOfWeek++) {
                ...
                dayLabel.setBackground(CommonConstants.SECONDARY_COLOR);
                ...
                dayLabel.addMouseListener(new MouseAdapter() {
                    @Override
                    public void mouseClicked(MouseEvent e) {
                        selectedDateLabel.setText(thisDay.toString());
                        selectedDateLabel.setForeground(Color.BLACK);
                        SwingUtilities.getWindowAncestor(MiniCalendar.this).dispose();
                    }

                    @Override
                    public void mouseEntered(MouseEvent e) {
                        dayLabel.setBackground(CommonConstants.TERTIARY_COLOR);
